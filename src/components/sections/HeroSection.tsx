...
const HeroSection = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      >
        {/* Overlay */}
        <div className="absolute inset-0 bg-gradient-to-b from-espresso/50 via-espresso/40 to-espresso/70" />
      </div>
      ...
      <div className="relative z-10 container mx-auto px-6 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex items-center justify-center gap-4 mb-8 opacity-0 animate-fade-up">
            ...
            <span className="text-gold font-serif text-sm tracking-[0.3em] uppercase">
              Est. Egypt
            </span>
            <div className="h-px w-16 bg-gold/60" />
          </div>
          ...
          {/* Logo/Name */}
          <h1 className="text-cream font-serif text-5xl md:text-7xl lg:text-8xl font-medium mb-6 opacity-0 animate-fade-up animation-delay-100 leading-tight">
            Donna del Mare
          </h1>

          {/* Tagline */}
          <p className="text-gold font-serif text-xl md:text-2xl italic mb-4 opacity-0 animate-fade-up animation-delay-200">
