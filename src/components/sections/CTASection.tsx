    ...
    <section className="bg-marble py-20 md:py-28 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
          <Button variant="luxuryGold" size="xl">
            Reserve Now
          </Button>
        ...
        <div className="text-center">
          <p className="text-muted-foreground font-sans text-sm mb-2">Open Daily</p>
          <p className="text-foreground font-serif text-lg">12:00 PM — 11:00 PM</p>
        </div>
      </div>
    </section>
  );
