        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {reasons.map((reason, index) => (
              <div
              key={index}
              className="flex items-start gap-4 p-6 rounded-2xl bg-background hover:shadow-soft transition-all duration-300 group"
            >
              <div className="w-8 h-8 rounded-full bg-olive/10 flex items-center justify-center flex-shrink-0 group-hover:bg-olive/20 transition-colors duration-300">
